-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_no_atan\hdlsrc\DOA_rearanged\MINRESRX2FFT_MEMSEL_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MINRESRX2FFT_MEMSEL_block1
-- Source Path: DOA_rearanged/FFTs/FFT Hydro 3/FFT HDL Optimized/MINRESRX2FFT_MEMSEL
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MINRESRX2FFT_MEMSEL_block1 IS
...
END MINRESRX2FFT_MEMSEL_block1;


ARCHITECTURE rtl OF MINRESRX2FFT_MEMSEL_block1 IS

  -- Signals
  SIGNAL btfOut1_re_signed                : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL btfOut1_im_signed                : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL btfOut2_re_signed                : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL btfOut2_im_signed                : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL stage_unsigned                   : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL MINRESRX2FFTMEMSEL_stgOut1Reg_re : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL MINRESRX2FFTMEMSEL_stgOut1Reg_im : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL MINRESRX2FFTMEMSEL_stgOut2Reg_re : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL MINRESRX2FFTMEMSEL_stgOut2Reg_im : signed(25 DOWNTO 0);  -- sfix26
  ...
  SIGNAL MINRESRX2FFTMEMSEL_stgOut1Reg_re_next : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL MINRESRX2FFTMEMSEL_stgOut1Reg_im_next : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL MINRESRX2FFTMEMSEL_stgOut2Reg_re_next : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL MINRESRX2FFTMEMSEL_stgOut2Reg_im_next : signed(25 DOWNTO 0);  -- sfix26_En8
  ...
  SIGNAL stgOut1_re_tmp                   : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL stgOut1_im_tmp                   : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL stgOut2_re_tmp                   : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL stgOut2_im_tmp                   : signed(25 DOWNTO 0);  -- sfix26_En8
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        MINRESRX2FFTMEMSEL_stgOut1Reg_re <= to_signed(16#0000000#, 26);
        MINRESRX2FFTMEMSEL_stgOut1Reg_im <= to_signed(16#0000000#, 26);
        MINRESRX2FFTMEMSEL_stgOut2Reg_re <= to_signed(16#0000000#, 26);
        MINRESRX2FFTMEMSEL_stgOut2Reg_im <= to_signed(16#0000000#, 26);
