-- -------------------------------------------------------------
-- 
-- File Name: test_enable_change\hdlsrc\Test_DOA\Fenetrage.vhd
...
-- 
-- Module: Fenetrage
-- Source Path: Test_DOA/FFTs/Fenetrage
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  Switch1_out1 <= Constant2_out1 WHEN Enable = '0' ELSE
      Constant1_out1;

  Add_out1 <= Switch1_out1 + Delay_out1;

  
  Compare_To_Constant_out1 <= '1' WHEN Delay_out1 <= to_unsigned(16#0100#, 16) ELSE
      '0';

  Logical_Operator3_out1 <= SampleHold_out1 AND Compare_To_Constant_out1;
