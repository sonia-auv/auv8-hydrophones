-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_no_atan\hdlsrc\DOA_rearanged\HDL_CMA_core_block.vhd
...
-- Source Path: DOA_rearanged/FFTs/FFT Hydro 2/HDL_CMA_core
-- Hierarchy Level: 3
-- 
...
ARCHITECTURE rtl OF HDL_CMA_core_block IS
  ...
  COMPONENT Quadrant_Correction_block
  ...
  FOR ALL : Quadrant_Correction_block
    USE ENTITY work.Quadrant_Correction_block(rtl);
...
BEGIN
  ...
  u_Iteration_11 : CordicKernelMag_block
  ...
  u_QuadrantCorrection : Quadrant_Correction_block
