-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_no_atan\hdlsrc\DOA_rearanged\MINRESRX2FFT_BTFSEL_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MINRESRX2FFT_BTFSEL_block2
-- Source Path: DOA_rearanged/FFTs/Subsystem/FFT HDL Optimized/MINRESRX2FFT_BTFSEL
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MINRESRX2FFT_BTFSEL_block2 IS
...
END MINRESRX2FFT_BTFSEL_block2;


ARCHITECTURE rtl OF MINRESRX2FFT_BTFSEL_block2 IS

  -- Signals
  SIGNAL din_1_re_signed                  : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL din_1_im_signed                  : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL dMemOut1_re_signed               : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL dMemOut1_im_signed               : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL dMemOut2_re_signed               : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL dMemOut2_im_signed               : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL stage_unsigned                   : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL minResRX2FFTBTFSEL_btfIn1Reg_re  : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL minResRX2FFTBTFSEL_btfIn1Reg_im  : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL minResRX2FFTBTFSEL_btfIn2Reg_re  : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL minResRX2FFTBTFSEL_btfIn2Reg_im  : signed(25 DOWNTO 0);  -- sfix26
  ...
  SIGNAL minResRX2FFTBTFSEL_dinReg1_re    : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL minResRX2FFTBTFSEL_dinReg1_im    : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL minResRX2FFTBTFSEL_dinReg2_re    : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL minResRX2FFTBTFSEL_dinReg2_im    : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL minResRX2FFTBTFSEL_dinReg3_re    : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL minResRX2FFTBTFSEL_dinReg3_im    : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL minResRX2FFTBTFSEL_dMemOut1Reg_re : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL minResRX2FFTBTFSEL_dMemOut1Reg_im : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL minResRX2FFTBTFSEL_dMemOut2Reg_re : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL minResRX2FFTBTFSEL_dMemOut2Reg_im : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL minResRX2FFTBTFSEL_dMemOutReg_vld : std_logic;
  SIGNAL minResRX2FFTBTFSEL_btfIn1Reg_re_next : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL minResRX2FFTBTFSEL_btfIn1Reg_im_next : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL minResRX2FFTBTFSEL_btfIn2Reg_re_next : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL minResRX2FFTBTFSEL_btfIn2Reg_im_next : signed(25 DOWNTO 0);  -- sfix26_En8
  ...
  SIGNAL minResRX2FFTBTFSEL_dinReg1_re_next : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL minResRX2FFTBTFSEL_dinReg1_im_next : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL minResRX2FFTBTFSEL_dinReg2_re_next : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL minResRX2FFTBTFSEL_dinReg2_im_next : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL minResRX2FFTBTFSEL_dinReg3_re_next : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL minResRX2FFTBTFSEL_dinReg3_im_next : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL minResRX2FFTBTFSEL_dMemOut1Reg_re_next : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL minResRX2FFTBTFSEL_dMemOut1Reg_im_next : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL minResRX2FFTBTFSEL_dMemOut2Reg_re_next : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL minResRX2FFTBTFSEL_dMemOut2Reg_im_next : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL minResRX2FFTBTFSEL_dMemOutReg_vld_next : std_logic;
  SIGNAL btfIn1_re_tmp                    : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL btfIn1_im_tmp                    : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL btfIn2_re_tmp                    : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL btfIn2_im_tmp                    : signed(25 DOWNTO 0);  -- sfix26_En8
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        minResRX2FFTBTFSEL_btfIn1Reg_re <= to_signed(16#0000000#, 26);
        minResRX2FFTBTFSEL_btfIn1Reg_im <= to_signed(16#0000000#, 26);
        minResRX2FFTBTFSEL_btfIn2Reg_re <= to_signed(16#0000000#, 26);
        minResRX2FFTBTFSEL_btfIn2Reg_im <= to_signed(16#0000000#, 26);
        minResRX2FFTBTFSEL_dinReg1_re <= to_signed(16#0000000#, 26);
        minResRX2FFTBTFSEL_dinReg1_im <= to_signed(16#0000000#, 26);
        minResRX2FFTBTFSEL_dinReg2_re <= to_signed(16#0000000#, 26);
        minResRX2FFTBTFSEL_dinReg2_im <= to_signed(16#0000000#, 26);
        minResRX2FFTBTFSEL_dinReg3_re <= to_signed(16#0000000#, 26);
        minResRX2FFTBTFSEL_dinReg3_im <= to_signed(16#0000000#, 26);
        minResRX2FFTBTFSEL_dMemOut1Reg_re <= to_signed(16#0000000#, 26);
        minResRX2FFTBTFSEL_dMemOut1Reg_im <= to_signed(16#0000000#, 26);
        minResRX2FFTBTFSEL_dMemOut2Reg_re <= to_signed(16#0000000#, 26);
        minResRX2FFTBTFSEL_dMemOut2Reg_im <= to_signed(16#0000000#, 26);
