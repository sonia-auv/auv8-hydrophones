-- -------------------------------------------------------------
-- 
-- File Name: update_snr\hdlsrc\Test_DOA\FFT_HDL_Optimized_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: FFT_HDL_Optimized_block2
-- Source Path: Test_DOA/FFTs/FFT Hydro Ref/FFT HDL Optimized
-- Hierarchy Level: 3
-- 
-- FFT HDL Optimized
-- 
...
ENTITY FFT_HDL_Optimized_block2 IS
...
END FFT_HDL_Optimized_block2;


ARCHITECTURE rtl OF FFT_HDL_Optimized_block2 IS

  -- Component Declarations
  COMPONENT TWDLROM_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT MINRESRX2FFT_MEMORY_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT MINRESRX2FFT_BTFSEL_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT MINRESRX2_BUTTERFLY_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT MINRESRX2FFT_MEMSEL_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT MINRESRX2FFT_CTRL_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din_1_re                        :   IN    std_logic_vector(16 DOWNTO 0);  -- sfix17
  ...
  COMPONENT MINRESRX2FFT_OUTMux_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          rdEnb1                          :   IN    std_logic;
  ...
  FOR ALL : TWDLROM_block2
    USE ENTITY work.TWDLROM_block2(rtl);

  FOR ALL : MINRESRX2FFT_MEMORY_block2
    USE ENTITY work.MINRESRX2FFT_MEMORY_block2(rtl);

  FOR ALL : MINRESRX2FFT_BTFSEL_block2
    USE ENTITY work.MINRESRX2FFT_BTFSEL_block2(rtl);

  FOR ALL : MINRESRX2_BUTTERFLY_block2
    USE ENTITY work.MINRESRX2_BUTTERFLY_block2(rtl);

  FOR ALL : MINRESRX2FFT_MEMSEL_block2
    USE ENTITY work.MINRESRX2FFT_MEMSEL_block2(rtl);

  FOR ALL : MINRESRX2FFT_CTRL_block2
    USE ENTITY work.MINRESRX2FFT_CTRL_block2(rtl);

  FOR ALL : MINRESRX2FFT_OUTMux_block2
    USE ENTITY work.MINRESRX2FFT_OUTMux_block2(rtl);
...
BEGIN
  u_MinResRX2FFT_TWDLROM : TWDLROM_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_MinResRX2FFT_MEMORY : MINRESRX2FFT_MEMORY_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_MinResRX2FFT_BTFSEL : MINRESRX2FFT_BTFSEL_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_MinResRX2FFT_BUTTERFLY : MINRESRX2_BUTTERFLY_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              btfIn1_re => btfIn1_re,  -- sfix17
  ...
  u_MinResRX2FFT_MEMSEL : MINRESRX2FFT_MEMSEL_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              btfOut1_re => btfOut1_re,  -- sfix17
  ...
  u_MinResRX2FFT_CTRL : MINRESRX2FFT_CTRL_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_1_re => std_logic_vector(dtc_re),  -- sfix17
  ...
  u_MinResRX2FFT_OUTMUX : MINRESRX2FFT_OUTMux_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              rdEnb1 => rdEnb1,
