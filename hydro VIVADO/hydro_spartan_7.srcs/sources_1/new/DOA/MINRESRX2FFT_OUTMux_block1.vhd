-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_no_atan\hdlsrc\DOA_rearanged\MINRESRX2FFT_OUTMux_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MINRESRX2FFT_OUTMux_block1
-- Source Path: DOA_rearanged/FFTs/FFT Hydro 3/FFT HDL Optimized/MINRESRX2FFT_OUTMux
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MINRESRX2FFT_OUTMux_block1 IS
...
END MINRESRX2FFT_OUTMux_block1;


ARCHITECTURE rtl OF MINRESRX2FFT_OUTMux_block1 IS
  ...
  SIGNAL minResRX2FFTOutMux_doutReg_re    : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL minResRX2FFTOutMux_doutReg_im    : signed(25 DOWNTO 0);  -- sfix26
  ...
  SIGNAL minResRX2FFTOutMux_doutReg_re_next : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL minResRX2FFTOutMux_doutReg_im_next : signed(25 DOWNTO 0);  -- sfix26_En8
  ...
  SIGNAL dOut_re_tmp                      : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL dOut_im_tmp                      : signed(25 DOWNTO 0);  -- sfix26_En8
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        minResRX2FFTOutMux_doutReg_re <= to_signed(16#0000000#, 26);
        minResRX2FFTOutMux_doutReg_im <= to_signed(16#0000000#, 26);
