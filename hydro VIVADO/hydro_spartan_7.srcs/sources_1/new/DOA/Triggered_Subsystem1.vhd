-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_no_atan\hdlsrc\DOA_rearanged\Triggered_Subsystem1.vhd
...
ARCHITECTURE rtl OF Triggered_Subsystem1 IS
  ...
  SIGNAL Delay_out1                       : signed(26 DOWNTO 0);  -- sfix27
  SIGNAL Delay_out1_bypass                : signed(26 DOWNTO 0);  -- sfix27
  SIGNAL Delay_out1_last_value            : signed(26 DOWNTO 0);  -- sfix27
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_gated = '1' THEN
        Delay_out1 <= Divide_out1;
      END IF;
    END IF;
  END PROCESS Delay_process;


  Debug_bypass_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay_out1_last_value <= to_signed(16#0000000#, 27);
      ELSIF enb_gated = '1' THEN
        Delay_out1_last_value <= Delay_out1_bypass;
      END IF;
    END IF;
  END PROCESS Debug_bypass_process;
  ...
  Debug <= std_logic_vector(Delay_out1_bypass);
