-- -------------------------------------------------------------
-- 
-- File Name: update_snr\hdlsrc\Test_DOA\MINRESRX2FFT_CTRL_block2.vhd
-- Created: 2022-05-09 08:23:23
-- 
...
ARCHITECTURE rtl OF MINRESRX2FFT_CTRL_block2 IS
  ...
  SIGNAL stgOut1_re_signed                : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL stgOut1_im_signed                : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL stgOut2_re_signed                : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL stgOut2_im_signed                : signed(16 DOWNTO 0);  -- sfix17
  ...
  SIGNAL minResRX2FFTCtrl_dOut1Re_Reg     : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL minResRX2FFTCtrl_dOut2Re_Reg     : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL minResRX2FFTCtrl_dOut1Im_Reg     : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL minResRX2FFTCtrl_dOut2Im_Reg     : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL minResRX2FFTCtrl_xSample_re      : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL minResRX2FFTCtrl_xSample_im      : signed(16 DOWNTO 0);  -- sfix17
  ...
  SIGNAL minResRX2FFTCtrl_dOut1Re_Reg_next : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL minResRX2FFTCtrl_dOut2Re_Reg_next : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL minResRX2FFTCtrl_dOut1Im_Reg_next : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL minResRX2FFTCtrl_dOut2Im_Reg_next : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL minResRX2FFTCtrl_xSample_re_next : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL minResRX2FFTCtrl_xSample_im_next : signed(16 DOWNTO 0);  -- sfix17
  ...
  SIGNAL dMemIn1_re_tmp                   : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL dMemIn1_im_tmp                   : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL dMemIn2_re_tmp                   : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL dMemIn2_im_tmp                   : signed(16 DOWNTO 0);  -- sfix17
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ...
        minResRX2FFTCtrl_dOut1Re_Reg <= to_signed(16#00000#, 17);
        minResRX2FFTCtrl_dOut2Re_Reg <= to_signed(16#00000#, 17);
        minResRX2FFTCtrl_dOut1Im_Reg <= to_signed(16#00000#, 17);
        minResRX2FFTCtrl_dOut2Im_Reg <= to_signed(16#00000#, 17);
        minResRX2FFTCtrl_rdEnb1_Reg <= '0';
        minResRX2FFTCtrl_rdEnb2_Reg <= '0';
        minResRX2FFTCtrl_rdEnb3_Reg <= '0';
        minResRX2FFTCtrl_xSample_re <= to_signed(16#00000#, 17);
        minResRX2FFTCtrl_xSample_im <= to_signed(16#00000#, 17);
  ...
  BEGIN
    ...
    CASE minResRX2FFTCtrl_state IS
      WHEN "0000" =>
        ...
        minResRX2FFTCtrl_dOut1Re_Reg_next <= to_signed(16#00000#, 17);
        minResRX2FFTCtrl_dOut2Re_Reg_next <= to_signed(16#00000#, 17);
        minResRX2FFTCtrl_dOut1Im_Reg_next <= to_signed(16#00000#, 17);
        minResRX2FFTCtrl_dOut2Im_Reg_next <= to_signed(16#00000#, 17);
        minResRX2FFTCtrl_xSample_re_next <= to_signed(16#00000#, 17);
        minResRX2FFTCtrl_xSample_im_next <= to_signed(16#00000#, 17);
