-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_no_atan\hdlsrc\DOA_rearanged\MINRESRX2FFT_MEMORY_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MINRESRX2FFT_MEMORY_block1
-- Source Path: DOA_rearanged/FFTs/FFT Hydro 3/FFT HDL Optimized/MINRESRX2FFT_MEMORY
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MINRESRX2FFT_MEMORY_block1 IS
...
END MINRESRX2FFT_MEMORY_block1;


ARCHITECTURE rtl OF MINRESRX2FFT_MEMORY_block1 IS
  ...
  -- Signals
  SIGNAL dMemIn1_re_signed                : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL intdelay_reg                     : vector_of_signed26(0 TO 1);  -- sfix26 [2]
  SIGNAL wrData01Dly_re                   : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL stage_unsigned                   : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL dMemIn2_re_signed                : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL intdelay_reg_1                   : vector_of_signed26(0 TO 1);  -- sfix26 [2]
  SIGNAL wrData10Dly_re                   : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL dMemIn2_im_signed                : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL intdelay_reg_2                   : vector_of_signed26(0 TO 1);  -- sfix26 [2]
  SIGNAL wrData10Dly_im                   : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL intdelay_reg_3                   : vector_of_signed26(0 TO 1);  -- sfix26 [2]
  SIGNAL wrData11Dly_re                   : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL intdelay_reg_4                   : vector_of_signed26(0 TO 1);  -- sfix26 [2]
  SIGNAL wrData11Dly_im                   : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL rdAddr10                         : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL wrAddr10                         : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL wrEnb11                          : std_logic;
  SIGNAL rdData11_im                      : std_logic_vector(25 DOWNTO 0);  -- ufix26
  SIGNAL rdData11_im_signed               : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL rdData11_re                      : std_logic_vector(25 DOWNTO 0);  -- ufix26
  SIGNAL rdData11_re_signed               : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL wrEnb10                          : std_logic;
  SIGNAL rdData10_im                      : std_logic_vector(25 DOWNTO 0);  -- ufix26
  SIGNAL rdData10_im_signed               : signed(25 DOWNTO 0);  -- sfix26_En8
  ...
  SIGNAL rdData10_re                      : std_logic_vector(25 DOWNTO 0);  -- ufix26
  SIGNAL rdData10_re_signed               : signed(25 DOWNTO 0);  -- sfix26_En8
  ...
  SIGNAL dMemOut2_re_tmp                  : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL dMemOut2_im_tmp                  : signed(25 DOWNTO 0);  -- sfix26_En8
  ...
  SIGNAL dMemOut1_re_tmp                  : std_logic_vector(25 DOWNTO 0);  -- ufix26
  SIGNAL dMemIn1_im_signed                : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL intdelay_reg_5                   : vector_of_signed26(0 TO 1);  -- sfix26 [2]
  SIGNAL wrData01Dly_im                   : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL dMemOut1_im_tmp                  : std_logic_vector(25 DOWNTO 0);  -- ufix26
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        intdelay_reg_2 <= (OTHERS => to_signed(16#0000000#, 26));
      ELSIF enb = '1' THEN
  ...
  BEGIN
    ...
    ELSE 
      dMemOut2_re_tmp <= to_signed(16#0000000#, 26);
      dMemOut2_im_tmp <= to_signed(16#0000000#, 26);
    END IF;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        intdelay_reg_5 <= (OTHERS => to_signed(16#0000000#, 26));
      ELSIF enb = '1' THEN
