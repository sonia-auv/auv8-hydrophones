-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_no_atan\hdlsrc\DOA_rearanged\Sample_and_Hold_block1.vhd
...
-- Source Path: DOA_rearanged/Maximum Hydro 1/SampleHold5/Sample and Hold
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Sample_and_Hold_block1 IS
  ...
  SIGNAL In_signed                        : signed(28 DOWNTO 0);  -- sfix29_En26
  SIGNAL In_bypass                        : signed(28 DOWNTO 0);  -- sfix29_En26
  SIGNAL In_last_value                    : signed(28 DOWNTO 0);  -- sfix29_En26
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        In_last_value <= to_signed(16#00000000#, 29);
