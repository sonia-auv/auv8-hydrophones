-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_no_atan\hdlsrc\DOA_rearanged\MINRESRX2FFT_CTRL_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: MINRESRX2FFT_CTRL_block1
-- Source Path: DOA_rearanged/FFTs/FFT Hydro 3/FFT HDL Optimized/MINRESRX2FFT_CTRL
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MINRESRX2FFT_CTRL_block1 IS
...
END MINRESRX2FFT_CTRL_block1;


ARCHITECTURE rtl OF MINRESRX2FFT_CTRL_block1 IS

  -- Signals
  SIGNAL din_1_re_signed                  : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL din_1_im_signed                  : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL stgOut1_re_signed                : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL stgOut1_im_signed                : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL stgOut2_re_signed                : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL stgOut2_im_signed                : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL minResRX2FFTCtrl_rdyReg          : std_logic;
  SIGNAL minResRX2FFTCtrl_inSampleCnt     : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL minResRX2FFTCtrl_outSampleCnt    : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL minResRX2FFTCtrl_state           : unsigned(3 DOWNTO 0);  -- ufix4
  SIGNAL minResRX2FFTCtrl_stageReg        : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL minResRX2FFTCtrl_procCnt         : unsigned(6 DOWNTO 0);  -- ufix7
  ...
  SIGNAL minResRX2FFTCtrl_dOut1Re_Reg     : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL minResRX2FFTCtrl_dOut2Re_Reg     : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL minResRX2FFTCtrl_dOut1Im_Reg     : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL minResRX2FFTCtrl_dOut2Im_Reg     : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL minResRX2FFTCtrl_xSample_re      : signed(25 DOWNTO 0);  -- sfix26
  SIGNAL minResRX2FFTCtrl_xSample_im      : signed(25 DOWNTO 0);  -- sfix26
  ...
  SIGNAL minResRX2FFTCtrl_inSampleCnt_next : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL minResRX2FFTCtrl_outSampleCnt_next : unsigned(7 DOWNTO 0);  -- ufix8
  ...
  SIGNAL minResRX2FFTCtrl_procCnt_next    : unsigned(6 DOWNTO 0);  -- ufix7
  ...
  SIGNAL minResRX2FFTCtrl_dOut1Re_Reg_next : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL minResRX2FFTCtrl_dOut2Re_Reg_next : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL minResRX2FFTCtrl_dOut1Im_Reg_next : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL minResRX2FFTCtrl_dOut2Im_Reg_next : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL minResRX2FFTCtrl_xSample_re_next : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL minResRX2FFTCtrl_xSample_im_next : signed(25 DOWNTO 0);  -- sfix26_En8
  ...
  SIGNAL dMemIn1_re_tmp                   : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL dMemIn1_im_tmp                   : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL dMemIn2_re_tmp                   : signed(25 DOWNTO 0);  -- sfix26_En8
  SIGNAL dMemIn2_im_tmp                   : signed(25 DOWNTO 0);  -- sfix26_En8
...
BEGIN
  ...
  -- minResRX2FFTCtrl
  minResRX2FFTCtrl_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        minResRX2FFTCtrl_state <= to_unsigned(16#0#, 4);
        minResRX2FFTCtrl_rdyReg <= '1';
        minResRX2FFTCtrl_inSampleCnt <= to_unsigned(16#00#, 8);
        minResRX2FFTCtrl_outSampleCnt <= to_unsigned(16#00#, 8);
        minResRX2FFTCtrl_procCnt <= to_unsigned(16#00#, 7);
        ...
        minResRX2FFTCtrl_dOut1Re_Reg <= to_signed(16#0000000#, 26);
        minResRX2FFTCtrl_dOut2Re_Reg <= to_signed(16#0000000#, 26);
        minResRX2FFTCtrl_dOut1Im_Reg <= to_signed(16#0000000#, 26);
        minResRX2FFTCtrl_dOut2Im_Reg <= to_signed(16#0000000#, 26);
        minResRX2FFTCtrl_rdEnb1_Reg <= '0';
        minResRX2FFTCtrl_rdEnb2_Reg <= '0';
        minResRX2FFTCtrl_rdEnb3_Reg <= '0';
        minResRX2FFTCtrl_xSample_re <= to_signed(16#0000000#, 26);
        minResRX2FFTCtrl_xSample_im <= to_signed(16#0000000#, 26);
  ...
  BEGIN
    ...
    CASE minResRX2FFTCtrl_state IS
      WHEN "0000" =>
        ...
        minResRX2FFTCtrl_inSampleCnt_next <= to_unsigned(16#00#, 8);
        minResRX2FFTCtrl_outSampleCnt_next <= to_unsigned(16#00#, 8);
        minResRX2FFTCtrl_waitCnt_next <= to_unsigned(16#0#, 3);
        minResRX2FFTCtrl_memWait_next <= to_unsigned(16#0#, 2);
        minResRX2FFTCtrl_procCnt_next <= to_unsigned(16#00#, 7);
        ...
        minResRX2FFTCtrl_dOut1Re_Reg_next <= to_signed(16#0000000#, 26);
        minResRX2FFTCtrl_dOut2Re_Reg_next <= to_signed(16#0000000#, 26);
        minResRX2FFTCtrl_dOut1Im_Reg_next <= to_signed(16#0000000#, 26);
        minResRX2FFTCtrl_dOut2Im_Reg_next <= to_signed(16#0000000#, 26);
        minResRX2FFTCtrl_xSample_re_next <= to_signed(16#0000000#, 26);
        minResRX2FFTCtrl_xSample_im_next <= to_signed(16#0000000#, 26);
        ...
        IF validIn = '1' THEN 
          ...
          minResRX2FFTCtrl_inSampleCnt_next <= to_unsigned(16#01#, 8);
      ...
      WHEN "0001" =>
        ...
        IF validIn = '1' THEN 
          minResRX2FFTCtrl_wrEnb1_Reg_next <= '1';
          IF minResRX2FFTCtrl_inSampleCnt = to_unsigned(16#7F#, 8) THEN 
            minResRX2FFTCtrl_state_next <= to_unsigned(16#2#, 4);
            minResRX2FFTCtrl_stageReg_next <= to_unsigned(16#0#, 3);
            minResRX2FFTCtrl_inSampleCnt_next <= minResRX2FFTCtrl_inSampleCnt + to_unsigned(16#01#, 8);
          ELSE 
            minResRX2FFTCtrl_inSampleCnt_next <= minResRX2FFTCtrl_inSampleCnt + to_unsigned(16#01#, 8);
          END IF;
        END IF;
        ...
        minResRX2FFTCtrl_rdEnb1_Reg_next <= '0';
        IF minResRX2FFTCtrl_outSampleCnt > to_unsigned(16#7F#, 8) THEN 
          ...
          minResRX2FFTCtrl_outSampleCnt_next <= minResRX2FFTCtrl_outSampleCnt + to_unsigned(16#01#, 8);
        ELSE 
          minResRX2FFTCtrl_unLoadReg_next <= '0';
          minResRX2FFTCtrl_rdEnb2_Reg_next <= '0';
          minResRX2FFTCtrl_rdEnb3_Reg_next <= '0';
      ...
      WHEN "0010" =>
        ...
        IF validIn = '1' THEN 
          ...
          IF minResRX2FFTCtrl_inSampleCnt = to_unsigned(16#FF#, 8) THEN 
        ...
        IF stgOut_vld = '1' THEN 
          minResRX2FFTCtrl_procCnt_next <= minResRX2FFTCtrl_procCnt + to_unsigned(16#01#, 7);
          minResRX2FFTCtrl_wrEnb1_Reg_next <= '1';
      ...
      WHEN "0011" =>
        ...
        minResRX2FFTCtrl_dOut2Im_Reg_next <= stgOut2_im_signed;
        IF stgOut_vld = '1' THEN 
          IF minResRX2FFTCtrl_procCnt = to_unsigned(16#7F#, 7) THEN 
      ...
      WHEN "0100" =>
        ...
        minResRX2FFTCtrl_btfInVld_Reg_next <= minResRX2FFTCtrl_rdEnb1_Reg;
        minResRX2FFTCtrl_initICReg_next <= '0';
        IF minResRX2FFTCtrl_inSampleCnt = to_unsigned(16#FE#, 8) THEN 
        ...
        ELSE 
          ...
          minResRX2FFTCtrl_rdEnb2_Reg_next <= stageLSB;
          minResRX2FFTCtrl_rdEnb3_Reg_next <=  NOT stageLSB;
          minResRX2FFTCtrl_inSampleCnt_next <= minResRX2FFTCtrl_inSampleCnt + to_unsigned(16#02#, 8);
        END IF;
        minResRX2FFTCtrl_wrEnb1_Reg_next <= '0';
        minResRX2FFTCtrl_wrEnb2_Reg_next <= '0';
        minResRX2FFTCtrl_wrEnb3_Reg_next <= '0';
      ...
      WHEN "0110" =>
        ...
        IF minResRX2FFTCtrl_memWait = to_unsigned(16#2#, 2) THEN 
          IF minResRX2FFTCtrl_stageReg = to_unsigned(16#6#, 3) THEN 
      ...
      WHEN "1010" =>
        ...
        IF minResRX2FFTCtrl_outSampleCnt < to_unsigned(16#80#, 8) THEN 
          minResRX2FFTCtrl_rdEnb1_Reg_next <= '1';
          minResRX2FFTCtrl_rdEnb2_Reg_next <= '0';
          minResRX2FFTCtrl_rdEnb3_Reg_next <= '0';
        ELSE 
