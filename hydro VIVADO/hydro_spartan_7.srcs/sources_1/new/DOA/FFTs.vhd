-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_no_atan\hdlsrc\DOA_rearanged\FFTs.vhd
...
-- 
-- Module: FFTs
-- Source Path: DOA_rearanged/FFTs
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF FFTs IS
  ...
  SIGNAL Subsystem_out1                   : std_logic_vector(26 DOWNTO 0);  -- ufix27
  SIGNAL Subsystem_out2                   : std_logic_vector(28 DOWNTO 0);  -- ufix29
...
BEGIN
  ...
  u_Subsystem : Subsystem
    PORT MAP( clk => clk,
              ...
              Magnitude => Subsystem_out1,  -- sfix27_En8
              Angle => Subsystem_out2,  -- sfix29_En26
              Valid => Subsystem_out3,
              Ready => Subsystem_out4
              );
  ...
  Magnitude_Ref <= Subsystem_out1;

  Phase_Ref <= Subsystem_out2;

  Valid_out_Ref <= Subsystem_out3;
