...
#
# Generated by Vivado on Tue Sep 07 20:27:11 -0400 2021
...
simulate()
{
  xsim fifo_generator_0 -key {Behavioral:sim_1:Functional:fifo_generator_0} -tclbatch cmd.tcl -protoinst "protoinst_files/mb_system.protoinst" -log simulate.log
}
