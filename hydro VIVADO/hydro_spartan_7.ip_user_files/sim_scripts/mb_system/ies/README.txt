...
#
# Generated by export_simulation on Fri Jul 15 15:46:23 -0400 2022
#
################################################################################
...
'-reset_run' switch to the './mb_system.sh' script.

./mb_system.sh -reset_run
...
./mb_system.sh -noclean_files

For more information on the script, please type './mb_system.sh -help'.
