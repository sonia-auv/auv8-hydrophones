...
HD_PWD='C:/Users/franc/hydro_spartan_7/hydro_spartan_7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hydro_spartan_7.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hydro_spartan_7.tcl -notrace
