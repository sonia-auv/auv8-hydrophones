...
HD_PWD='C:/Users/franc/hydro_spartan_7/hydro_spartan_7.runs/mb_system_clk_wiz_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_system_clk_wiz_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_system_clk_wiz_1_1.tcl
