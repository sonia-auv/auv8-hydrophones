...
HD_PWD='C:/Users/franc/hydro_spartan_7/hydro_spartan_7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hydro_spartan_7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hydro_spartan_7.tcl
