...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../dev_board_test.gen/sources_1/bd/design_1/ipshared/d0f7" \
       +incdir+"$ref_dir/../../../../dev_board_test.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../dev_board_test.gen/sources_1/bd/design_1/ipshared/d0f7" \
       +incdir+"../../../../dev_board_test.gen/sources_1/bd/design_1/ipshared/ec67/hdl"
}
