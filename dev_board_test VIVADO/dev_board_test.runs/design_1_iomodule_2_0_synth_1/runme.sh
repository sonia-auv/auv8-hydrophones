...
HD_PWD='C:/Users/franc/dev_board_test/dev_board_test.runs/design_1_iomodule_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_iomodule_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_iomodule_2_0.tcl
