...
HD_PWD='C:/Users/franc/dev_board_test/dev_board_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_block.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ram_block.tcl -notrace
