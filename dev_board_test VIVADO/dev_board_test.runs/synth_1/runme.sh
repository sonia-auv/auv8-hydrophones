...
HD_PWD='C:/Users/franc/dev_board_test/dev_board_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_block.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_block.tcl
