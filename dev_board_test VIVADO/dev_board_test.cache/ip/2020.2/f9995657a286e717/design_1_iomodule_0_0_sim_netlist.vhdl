...
begin
  GPO2(0) <= \^gpo2\(0);
\TMR_No.gpo_io_i[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EFFF2000"
    )
        port map (
...
\TMR_No.gpo_io_i[0]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFEF"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_iomodule is
  ...
  signal io_bus_read_data : STD_LOGIC_VECTOR ( 0 to 0 );
