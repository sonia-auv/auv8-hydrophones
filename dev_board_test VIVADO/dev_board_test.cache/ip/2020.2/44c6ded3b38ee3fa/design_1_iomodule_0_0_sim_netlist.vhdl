...
architecture STRUCTURE of \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_GPI_Module__parameterized1\ is
  ...
  signal \Using_GPI.GPI_In[1]_i_1_n_0\ : STD_LOGIC;
  signal \Using_GPI.GPI_In[1]_i_2_n_0\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \Using_GPI.GPI_In[0]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \Using_GPI.GPI_In[1]_i_1\ : label is "soft_lutpair0";
begin
\Using_GPI.GPI_In[0]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
        ...
        port map (
      I0 => GPI2(0),
      I1 => \Using_GPI.GPI_In[1]_i_2_n_0\,
...
\Using_GPI.GPI_In[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      ...
      I0 => GPI2(1),
      I1 => \Using_GPI.GPI_In[1]_i_2_n_0\,
      O => \Using_GPI.GPI_In[1]_i_1_n_0\
    );
\Using_GPI.GPI_In[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
GPI_I2: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_GPI_Module__parameterized1\
     port map (
      Clk => Clk,
      GPI2(1 downto 0) => GPI2(1 downto 0),
      Q(4 downto 0) => Q(4 downto 0),
      Sl_DBus(1 downto 0) => Sl_DBus(1 downto 0),
      Sl_Wait => Sl_Wait
    );
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_iomodule is
  ...
  attribute C_GPI2_SIZE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_iomodule : entity is 2;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_iomodule is
  ...
  signal \^sl_dbus\ : STD_LOGIC_VECTOR ( 30 to 31 );
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of lmb_reg_read_i_1 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of lmb_reg_write_i_1 : label is "soft_lutpair1";
...
begin
  ...
  Sl_DBus(28) <= \<const0>\;
  Sl_DBus(29) <= \<const0>\;
  Sl_DBus(30 to 31) <= \^sl_dbus\(30 to 31);
  Sl_UE <= \<const0>\;
  Sl_Wait <= \^sl_wait\;
  ToVote(1023) <= \<const0>\;
  ToVote(1022) <= \<const0>\;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal NLW_U0_Sl_DBus_UNCONNECTED : STD_LOGIC_VECTOR ( 0 to 29 );
  ...
  attribute C_GPI2_SIZE : integer;
  attribute C_GPI2_SIZE of U0 : label is 2;
  attribute C_GPI3_INTERRUPT : integer;
  ...
  attribute x_interface_parameter of GPO2 : signal is "XIL_INTERFACENAME GPIO2, C_USE_GPO2 1, C_GPO2_SIZE 1, C_GPO2_INIT 0x00000000, C_USE_GPI2 1, C_GPI2_SIZE 2, C_GPI2_INTERRUPT 0, BOARD.ASSOCIATED_PARAM GPIO2_BOARD_INTERFACE";
...
U0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_iomodule
     port map (
      ...
      Sl_DBus(0 to 29) => NLW_U0_Sl_DBus_UNCONNECTED(0 to 29),
      Sl_DBus(30 to 31) => \^sl_dbus\(30 to 31),
      Sl_Ready => Sl_Ready,
