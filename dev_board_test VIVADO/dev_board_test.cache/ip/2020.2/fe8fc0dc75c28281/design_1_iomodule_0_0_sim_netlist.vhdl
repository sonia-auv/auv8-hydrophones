...
\Using_GPI.GPI_In[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0200"
    )
        port map (
...
\Using_GPI.GPI_In[0]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFD"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_intr_ctrl is
  port (
    ...
    Clk : in STD_LOGIC;
    Rst : in STD_LOGIC;
    \INTC_CISR_reg[16]_0\ : in STD_LOGIC;
    Q : in STD_LOGIC_VECTOR ( 4 downto 0 );
    lmb_reg_read : in STD_LOGIC;
    lmb_reg_write : in STD_LOGIC;
...
begin
\All_INTR_Bits[16].Using_Intr.CISR_CIER_TMR_No.cier[16]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\All_INTR_Bits[16].Using_Intr.CISR_CIER_TMR_No.cier[16]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\All_INTR_Bits[16].Using_Intr.CISR_CIER_TMR_No.cisr[16]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"BFAA"
    )
        port map (
      ...
      I1 => \out\(0),
      I2 => INTC_WRITE_CIAR,
      I3 => \All_INTR_Bits[16].Using_Intr.CISR_CIER_TMR_No.cisr_reg_n_0_[16]\,
      O => \All_INTR_Bits[16].Using_Intr.CISR_CIER_TMR_No.cisr[16]_i_1_n_0\
    );
\All_INTR_Bits[16].Using_Intr.CISR_CIER_TMR_No.cisr[16]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
intr_ctrl_I1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_intr_ctrl
     port map (
      Clk => Clk,
      \INTC_CISR_reg[16]_0\ => GPI_I1_n_0,
      INTC_IRQ => INTC_IRQ,
      INTC_Interrupt(0) => INTC_Interrupt(0),
      Q(4 downto 0) => Q(4 downto 0),
      Rst => Rst,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute x_interface_parameter of GPO1 : signal is "XIL_INTERFACENAME GPIO1, C_USE_GPO1 1, C_GPO1_SIZE 8, C_GPO1_INIT 0x00000000, C_USE_GPI1 1, C_GPI1_SIZE 1, C_GPI1_INTERRUPT 0, BOARD.ASSOCIATED_PARAM GPIO1_BOARD_INTERFACE";
